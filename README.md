...
Keep note of your client_id and secret_id, save in a notepad, keep to yourself, don't share with anyone!
 ...
 1) [Python Script](https://github.com/TheeChody/ChodelingApp/main/README.md#1-python-install-only-need-to-do-if-using-python-to-run-app-if-using-the-packaged-exe-skip)
 2) [.exe file](https://github.com/TheeChody/ChodelingApp/main/README.md#2-exe-install-only-for-running-the-exe-file-if-using-python-skip)
