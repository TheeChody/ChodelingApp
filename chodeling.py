...
async def fetch_setting(setting: str) -> int | tuple:
    if setting == "sortby":
        try:
            ...
            await bot.error_msg("fetch_setting", f"{bot.variables['types_sort']}' is not valid!! (Returning Index 0)", ValueError)
            return 0
    elif setting == "flash":
        try:
...
def hotkey_listen():
    ...
    try:
        ...
        keyboard.add_hotkey("ctrl+shift+b", lambda: keyboard.write(f"{clear_code}{bot.special_commands['bet']}\r"), 0, False)
        # keyboard.add_hotkey("ctrl+shift+b", lambda: sys.stderr.write(f"{bot.special_commands['bet']}\r"))
        # keyboard.add_hotkey("ctrl+shift+c", lambda: keyboard.write(f"{clear_code}{bot.special_commands['free_pack']}\r"), 0, False)
        # keyboard.add_hotkey("ctrl+shift+c", lambda: sys.stdout.write(f"{clear_code}{bot.special_commands['free_pack']}\r"))
        # keyboard.add_hotkey("ctrl+shift+d+b", lambda: keyboard.write(f"{clear_code}{bot.special_commands['bbet']}\r"))
        # keyboard.add_hotkey("ctrl+shift+d+b", lambda: sys.stdout.write(f"{clear_code}{bot.special_commands['bbet']}\r"))
        # keyboard.add_hotkey("ctrl+shift+f", lambda: keyboard.write(f"{clear_code}{bot.special_commands['fish']}\r"))
        # keyboard.add_hotkey("ctrl+shift+f", lambda: sys.stdout.write(f"{clear_code}{bot.special_commands['fish']}\r"))
        # keyboard.add_hotkey("ctrl+shift+h", lambda: keyboard.write(f"{clear_code}{bot.special_commands['heist']}\r"))
        # keyboard.add_hotkey("ctrl+shift+h", lambda: sys.stdout.write(f"{clear_code}{bot.special_commands['heist']}\r"))
        # keyboard.add_hotkey("ctrl+shift+j", lambda: keyboard.write(f"{clear_code}{bot.special_commands['joints_count_update']}\r"))
        # keyboard.add_hotkey("ctrl+shift+j", lambda: sys.stdout.write(f"{clear_code}{bot.special_commands['joints_count_update']}\r"))
        ...
        # keyboard.add_hotkey("ctrl+shift+r+b", lambda: sys.stdout.write(f"{clear_code}{bot.special_commands['fish_beet']}\r"))
        # keyboard.add_hotkey("ctrl+shift+s+r", lambda: keyboard.write(f"{clear_code}{bot.special_commands['fish_stroke']}\r"))
        # keyboard.add_hotkey("ctrl+shift+s+r", lambda: sys.stdout.write(f"{clear_code}{bot.special_commands['fish_stroke']}\r"))
        keyboard.wait()
    except Exception as e:
