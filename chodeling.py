                                ...
                                async def show_date(key_date: str):
                                    ...
                                    while True:
                                        ...
                                        try:
                                            ...
                                            await bot.msg_error("display_stats_bingo", f"Error Building Times For {key_date}", error_building_bingo_date)
                                        if len(options) > 0:
